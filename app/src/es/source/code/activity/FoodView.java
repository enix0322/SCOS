    ...
    class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (list.get(position).equals(titles[0])){
                ...
                Food_data.add(new Food("荷兰豆炒腊肉", "10"));
                Food_data.add(new Food("海蟹酱炒鸡蛋", "20"));
                Food_data.add(new Food("美味干锅排骨", "30"));
                Food_data.add(new Food("腊鸭腿青菜煮年糕", "10"));
                Food_data.add(new Food("红烧冻豆腐", "20"));
                Food_data.add(new Food("蒜蓉粉丝蒸虾", "30"));
                Food_data.add(new Food("大葱炒肉", "10"));
                Food_data.add(new Food("美味干锅排骨", "20"));
                Food_data.add(new Food("红烧冻豆腐", "30"));

                fragmentfood.addFood(Food_data);
            }else if (list.get(position).equals(titles[2])){
                Food_data.add(new Food("盐焗蛏", "10"));
                Food_data.add(new Food("原味皮皮虾", "20"));
                Food_data.add(new Food("烤箱版蒸梭子蟹", "30"));
                Food_data.add(new Food("吮指麻辣蟹", "10"));
                Food_data.add(new Food("烤花甲", "20"));
                Food_data.add(new Food("花甲粉丝", "30"));
                Food_data.add(new Food("香辣花甲", "10"));
                Food_data.add(new Food("炒海瓜子", "20"));
                Food_data.add(new Food("香辣螃蟹", "30"));
                Food_data.add(new Food("花甲炖蛋", "10"));
                Food_data.add(new Food("辣炒花蛤蜊", "20"));
                Food_data.add(new Food("黄瓜虾仁", "30"));
                Food_data.add(new Food("浇汁鲍鱼", "10"));
                Food_data.add(new Food("虾仁蒸豆腐", "20"));
                Food_data.add(new Food("金汤虾球烩豆腐", "30"));
                Food_data.add(new Food("煎虾", "10"));
                Food_data.add(new Food("清蒸大闸蟹", "20"));
                Food_data.add(new Food("清蒸大头虾", "30"));
                Food_data.add(new Food("蒜蓉酱蒸珍宝蚝", "10"));
                Food_data.add(new Food("炒鱿鱼", "20"));
                Food_data.add(new Food("浇汁鲍鱼", "30"));
                Food_data.add(new Food("虾仁土豆条", "10"));
                Food_data.add(new Food("肉螺炒鸡蛋", "20"));
                Food_data.add(new Food("花蛤炒虾蛄", "30"));
                Food_data.add(new Food("蒸螃蟹", "10"));
                Food_data.add(new Food("葱油青口贝", "20"));
                Food_data.add(new Food("黄金蟹斗", "30"));
                Food_data.add(new Food("蒜味虾", "10"));
                Food_data.add(new Food("清炒黄蚬", "20"));
                ...
                Food_data.add(new Food("南果梨汁", "3"));
                Food_data.add(new Food("金骏眉茶", "3"));
                Food_data.add(new Food("浓香豆浆", "3"));
                Food_data.add(new Food("糖桂花柠檬水", "3"));
                Food_data.add(new Food("猕猴桃酸奶杯", "3"));
                Food_data.add(new Food("树莓蜜", "3"));
                Food_data.add(new Food("红豆西米奶茶", "3"));
                Food_data.add(new Food("双豆豆浆", "3"));
                Food_data.add(new Food("椰奶拿铁咖啡", "3"));
                Food_data.add(new Food("鲜榨石榴汁", "3"));
                Food_data.add(new Food("西柚柠檬苏打水", "3"));
                Food_data.add(new Food("毛樱桃汁", "3"));
                Food_data.add(new Food("棉花糖巧克力热饮", "3"));
                Food_data.add(new Food("红豆莲藕糊", "3"));
